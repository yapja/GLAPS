<?php 
	...
	if (isset($_REQUEST['afid']))
	{
		...
		if (ctype_digit($_REQUEST['afid']))
		{
			...
			$sql_delete = "UPDATE attendance_flexible SET status = 'Denied', approved_by = $employee_detail_ID WHERE attendance_flexible_ID = $attendance_flexible_ID"; 
            ...
            $sql_log = "INSERT INTO system_log VALUES ('', NOW(), $account_ID, 'Denied $name attendance')";
