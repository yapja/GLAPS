<?php 
	...
	$employee_ID = $_SESSION['employee_ID'];
  	...
  	$sql_overtime = "SELECT e.first_name, e.last_name, ott.type, eot.date_start, eot.date_end, eot.reason
	FROM employee e
	...
	if (isset($_POST['file']))
	{
		...
		$sql_reject = "UPDATE employee_overtime SET date_updated = NOW(), validated_by = $employee_ID, status = 'Rejected', remark = '$remark' WHERE employee_overtime_ID = $employee_overtime_ID";
        ...
        $sql_select = "SELECT e.first_name, e.last_name, ot.type FROM employee e 
            ...
            $sql_log = "INSERT INTO system_log VALUES ('', NOW(), $account_ID, 'Denied $otype overtime of $name')";
