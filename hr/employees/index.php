						...
						echo "
							<tr>
								...
								<td align='center'>
                                    ...
                                    <a href='../leave/addleave.php?id=$employee_detail_ID' class='btn btn-xs btn-success'>Add Leave</a>
									<a href='details.php?id=$employee_ID' class='btn btn-xs btn-info'>
										<i class='fa fa-edit'></i>
									</a>
									<a href='delete.php?id=$employee_detail_ID' class='btn btn-xs btn-danger' 
										onclick='return confirm(\"Archive employee?\");''>
