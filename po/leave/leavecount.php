	...
	<div class="col-lg-6">
        <div class="form-group">
            ...
            <?php 
                ...
                {
                echo "<div class='col-lg-4'><a href='file.php?id=1' class='btn btn-md btn-success'>File a Leave</a></div>";
                }
            ?>
		</div>
		<div class="form-group">
            ...
            <?php 
                ...
                {
                echo "<div class='col-lg-4'><a href='file.php?id=2' class='btn btn-md btn-success'>File a Leave</a></div>";
                }
            ?>
		</div>
		<div class="form-group">
            ...
            <?php 
                ...
                {
                echo "<div class='col-lg-4'><a href='file.php?id=3' class='btn btn-md btn-success'>File a Leave</a></div>";
                }
            ?>
		</div>
		<div class="form-group">
            ...
            <?php 
                if ($emergency_leave <= 0)
                {
                    
                }
                else
                {
                echo "<div class='col-lg-4'><a href='file.php?id=4' class='btn btn-md btn-success'>File a Leave</a></div>";
                }
            ?>
		</div>
		<div class="form-group">
            ...
            <?php 
                ...
                {
                echo "<div class='col-lg-4'><a href='file.php?id=5' class='btn btn-md btn-success'>File a Leave</a></div>";
                }
            ?>
		</div>
	</div>
