...
if (isset($_POST['update']))
{
    ...
    $sql_discrepancy_update = "UPDATE salary_report_discrepancy SET reason = '$reason', date_filed = NOW(), filed_by = $employee_detail_ID WHERE salary_report_discrepancy_ID = $salary_report_discrepancy_ID";
    $con->query($sql_discrepancy_update);

    $sql_delete = "UPDATE salary_report SET status = 'Rejected' WHERE salary_report_ID = $salary_report_ID"; 
    $result = $con->query($sql_delete) or die(mysqli_error($con));
...
<form method="POST" class="form-horizontal">
    <div class="col-lg-6">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <textarea name="reason" style="width:200%;height:80px;" placeholder="Details of the discrepancy"></textarea>
            </div>
        </div>
        <div class="form-group">
            <div class="col-lg-offset-4 col-lg-8">
                <button name="update" type="submit" class="btn btn-danger">
                    Deny
                </button>
            </div>
        </div>
