<?php 
	...
	else if(isset($_GET['eid']) && isset($_GET['pid']))
	{
		...
		$sql_salary = "SELECT salary_report_ID, basic_salary, transportation, gas, food, SSS, HDMF, PhilHealth, late, absent, legal, sunday, sunday_excess, special_day, special_excess, regular_holiday, regular_excess, bonus, withholding_tax, net_pay FROM salary_report WHERE employee_detail_ID = $employee_detail_ID AND period_ID = $period_ID";
		$result_salary = $con->query($sql_salary);
		while ($row = mysqli_fetch_array($result_salary))
		{
...
<form method="POST" class="form-horizontal">
    ...
    <div class="col-lg-6">
        ...
        <div class="col-lg-6" align="right">
			<a href="approve.php?srid=<?= $salary_report_ID ?>" class="btn btn-md btn-success">Approve</a>
			<a href="denyreason.php?srid=<?= $salary_report_ID ?>" class="btn btn-md btn-danger">Deny</a>
        </div>
	</div>
