<?php 
	...
	if (isset($_REQUEST['id']))
	{
		...
		if (ctype_digit($_REQUEST['id']))
		{
			...
			$sql_approve = "UPDATE additional_contribution SET status = 'Denied', approved_by = $employee_detail_ID WHERE additional_contribution_ID = $additional_contribution_ID"; 
            ...
            $sql_log = "INSERT INTO system_log VALUES ('', NOW(), $account_ID, 'Denied $name contribution')";
