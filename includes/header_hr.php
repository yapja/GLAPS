    ...
    <div class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                <a id="home" href="<?php echo app_path ?>hr" class="navbar-brand"><img src="<?php echo app_path ?>images/glb.png" style="height: 30px; width: 300px;"></a>
            ...
            <div class="navbar-collapse collapse" id="navbar-main" style="height: 1px;">
                <ul class="nav navbar-nav pull-left">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo app_path ?>hr/webcam/webcam.php">Take a Photo</a></li>
                            <li><a href="<?php echo app_path ?>hr/attendance/file.php">File Attendance</a></li>
                            <li><a href="<?php echo app_path ?>hr/attendance/index.php">View MyAttendance</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="<?php echo app_path ?>hr/accounts/index.php">Accounts</a>
                    </li>
                    <li class="dropdown">
                        <a href="<?php echo app_path ?>hr/employees/index.php">Employees</a>
                    </li>
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="<?php echo app_path ?>">Leave
                        <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo app_path ?>hr/leave/index.php">View my Leave</a></li>
                            <li><a href="<?php echo app_path ?>hr/leave/file.php">File a Leave</a></li>
                            <li><a href="<?php echo app_path ?>hr/leave/leavecount.php">Leave Count</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo app_path ?>hr/overtime/index.php">View my Overtime</a></li>
                            <li><a href="<?php echo app_path ?>hr/overtime/file.php">File an Overtime</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="<?php echo app_path ?>hr/dashboard.php">Dashboard</a>
                    </li>
                    <li class="dropdown">
                        <a href="<?php echo app_path ?>hr/timesheet/index.php">Timesheet</a>
                    </li>
                </ul>
                <ul class="nav navbar-nav pull-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo app_path ?>hr/payroll/mypayslip.php">View My Payslip</a></li>
                            <li><a href="<?php echo app_path ?>hr/contribution/index.php">View My Contributions</a></li>
                            <li><a href="<?php echo app_path ?>hr/holiday/index.php">View Holidays</a></li>
                            <li class="divider"></li>
                            <li><a href="<?php echo app_path ?>hr/resetpassword.php">Reset Password</a></li>
