    ...
    <div class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                <a id="home" href="<?php echo app_path ?>it" class="navbar-brand"><img src="<?php echo app_path ?>images/glb.png" style="height: 30px; width: 300px;"></a>
            ...
            <div class="navbar-collapse collapse" id="navbar-main" style="height: 1px;">
                <ul class="nav navbar-nav pull-left">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo app_path ?>it/webcam/webcam.php">Take a Photo</a></li>
                            <li><a href="<?php echo app_path ?>it/attendance/file.php">File Attendance</a></li>
                            <li><a href="<?php echo app_path ?>it/attendance/index.php">View MyAttendance</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="<?php echo app_path ?>">Accounts
                        <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="<?php echo app_path ?>it/account/register.php">Add an Account</a>
                            </li>
                            <li>
                                <a href="<?php echo app_path ?>it/account/index.php">View Accounts</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo app_path ?>it/leave/index.php">View my Leave</a></li>
                            <li><a href="<?php echo app_path ?>it/leave/file.php">File a Leave</a></li>
                            <li><a href="<?php echo app_path ?>it/leave/leavecount.php">Leave Count</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo app_path ?>it/overtime/index.php">View my Overtime</a></li>
                            <li><a href="<?php echo app_path ?>it/overtime/file.php">File an Overtime</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="<?php echo app_path ?>it/timesheet/index.php">Timesheet</a>
                    </li>
                    <li class="dropdown">
                        <a href="<?php echo app_path ?>it/log/index.php">Audit Log</a>
                    </li>
                </ul>
                <ul class="nav navbar-nav pull-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo app_path ?>it/period/add.php">Add Period</a></li>
                            <li><a href="<?php echo app_path ?>it/payroll/mypayslip.php">View My Payslip</a></li>
                            <li><a href="<?php echo app_path ?>it/contribution/index.php">View My Contributions</a></li>
                            <li class="divider"></li>
                            <li><a href="<?php echo app_path ?>it/resetpassword.php">Reset Password</a></li>
